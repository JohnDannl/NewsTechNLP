...
refers to gensim.corpora.dictionary
...
logger = logging.getLogger('glove.dictionary')

class GvDictionary(utils.SaveLoad, Mapping):
    ...
    def from_documents(documents):
        return GvDictionary(documents=documents)
